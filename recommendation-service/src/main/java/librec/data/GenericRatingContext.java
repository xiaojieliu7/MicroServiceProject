 ...
 *
 */
public class GenericRatingContext extends Context implements Comparable<GenericRatingContext> {
     ...
     *            item id
     */
    public GenericRatingContext(int user, int item) {
        super(user, item);
    }

    public GenericRatingContext(int user, int item, long timestamp) {
        this(user, item);
    ...
    @Override
    public int compareTo(GenericRatingContext that) {
