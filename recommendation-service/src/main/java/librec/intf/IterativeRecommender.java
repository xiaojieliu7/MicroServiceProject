...
public abstract class IterativeRecommender extends Recommender {
	...
	public void setIterArray(int[] iters) {
//        iterArray = new int[iters.length];
//        for (int i = 0; i < iters.length; i++) {
//            this.iterArray[i] = iters[i];
//        }
		iterArray = iters;
	}
	...
	public static float getRegU() {
		return regU;
	}

	public static void setRegU(float regU) {
		IterativeRecommender.regU = regU;
	}

	public static float getRegI() {
		return regI;
	}

	public static void setRegI(float regI) {
		IterativeRecommender.regI = regI;
	}
	...
	public static void setNumFactors(int numFactors) {
		IterativeRecommender.numFactors = numFactors;
	}
	...
	public static void setNumIters(int numIters) {
		IterativeRecommender.numIters = numIters;
	}

	public DenseVector getUserBias() {
		return userBias;
	}

	public void setUserBias(DenseVector userBias) {
		this.userBias = userBias;
	}

	public DenseVector getItemBias() {
		return itemBias;
	}

	public void setItemBias(DenseVector itemBias) {
